...
console.log(showTeamPosition(3)); // O time que está em 3º lugar é o Cabofriense.
console.log(showTeamPosition(4)); // O time que está em 3º lugar é o Cabofriense.
console.log(showTeamPosition(5)); // O time que está em 4º lugar é o Bangu.
